...
export const demoTopics: InstituteTopic[] = [
  {
    name: "政治参加",
    description: "制度との距離、争点の伝わり方、参加しやすさを調べます。",
  },
  {
    name: "世論",
    description: "態度の変化、争点認識、社会の空気を追います。",
  },
  {
    name: "ケア",
  ...
  {
    name: "雇用",
    description: "賃金、評価、不安定就業、職場の変化を定点で追います。",
  },
  {
    name: "地域社会",
    description: "都市と地方の孤立、自治、つながりの変化を扱います。",
  },
  {
    name: "情報環境",
  ...
  {
    name: "メディア",
    description: "報道、配信、接触経路の変化と判断への影響を扱います。",
  },
  {
    name: "宗教",
    description: "信仰、組織、価値観と社会参加の関係を扱います。",
  },
  {
    name: "教育",
...
export const demoResearchers: ResearcherProfile[] = [
  {
    ...
    bio:
      "自治体調査、選挙広報、若年層インタビューを通じて、参加のしにくさがどこで生まれるかを調べています。数字だけで結論を急がず、現場で何が分かりにくいのかを確認します。",
    portraitImage: {
  ...
  },
  {
    ...
    bio:
      "家庭内の役割分担を、目に見える作業だけでなく、段取りや調整責任まで含めて測る調査を設計しています。数量調査と聞き取りを組み合わせます。",
    portraitImage: {
  ...
  },
  {
    ...
    bio:
      "職場への技術導入が、不安や期待をどう変えるかを調べています。自由回答と小規模事業所への聞き取りを整理し、制度設計で使える論点にまとめます。",
    portraitImage: {
...
export const demoMethodologies: MethodologyEntry[] = [
  {
    ...
    body:
      "全国意識調査では、傾向を大きく見誤らないことを重視します。設問文を短くし、選択肢の順番を偏りにくい形にそろえ、地域・年齢・性別の構成比を補正したうえで解釈します。\n\nただし、全国調査だけでは『なぜそう答えたのか』までは十分に拾えません。松笠研究所では、自由回答や地域聞き取りもあわせて確認し、数字の背景を補います。",
    isDemo: true,
  },
  {
    ...
    title: "地域ヒアリング",
    summary: "自治体、支援団体、住民への聞き取りから、地域課題の詰まりを探ります。",
    ...
    body:
      "地域ヒアリングでは、制度の有無だけでなく、誰が最初の相談先になっているのかを確認します。行政、学校、支援団体、家族のあいだで情報がどう渡っているかを追うと、数字だけでは見えにくい詰まりどころが見えてきます。\n\n一方で、この方法だけでは代表性を示せません。松笠研究所では、住民アンケートや既存統計と突き合わせ、聞き取りだけで結論を広げすぎないようにします。",
    isDemo: true,
  },
  {
    ...
    slug: "time-use-diary",
    title: "時間配分ダイアリー",
    summary: "家事、育児、通勤、休息の時間配分を細かく測る方法です。",
    ...
    sourceBasis: "15分単位の行動記録と補助設問を組み合わせ、段取り作業も記録します。",
    body:
      "目に見えやすい家事だけを聞くと、分担の偏りは小さく見えてしまいます。時間配分ダイアリーでは、送り迎え、翌日の準備、連絡調整のような短く分散する作業も記録し、日常の拘束感を捉えます。\n\n一方で、この方法は回答負担が高いため、対象者の生活に合わせた説明と、記録しやすい入力画面が欠かせません。",
    isDemo: true,
  },
  {
    ...
    title: "自由回答コード化",
    summary: "自由記述を分類し、期待と不安がどこに向かっているかを整理します。",
    updatedDate: "2026-04-04",
    reviewer: "松田 里奈",
    focusTopics: ["情報環境", "雇用"],
    goodFor: [
      "選択式では拾いにくい不安や違和感を確認したいとき",
    ...
    body:
      "自由回答コード化は、数値だけでは見えにくい戸惑いや期待を整理する方法です。松笠研究所では、まず少数サンプルで分類案を作り、似た表現をどこまで同じ意味として扱うかを確認してから本集計に進みます。\n\nこの方法だけで全体傾向を断定することはしませんが、選択肢設計の見直しや、追加で聞くべき論点を見つけるうえで役に立ちます。",
    isDemo: true,
  },
  {
    ...
    title: "争点マッピング聞き取り",
    summary: "制度上の論点が、生活の言葉でどう受け止められるかを聞き取ります。",
    ...
    body:
      "『投票に行かない』という行動だけを見ても、なぜ距離が生まれるのかは分かりません。争点マッピング聞き取りでは、ニュース、生活課題、候補者像がどう結びついているかを順に聞きます。\n\nこの方法に代表性はありませんが、全国調査では見えにくい詰まりどころを見つけるのに向いています。",
    isDemo: true,
  },
];
...
export const demoReports: ResearchReport[] = [
  {
    ...
    body:
      "このブリーフィングでは、若年層が『投票に意味がない』と考えている、という単純な見方は採りません。候補者比較に必要な情報が届いていないこと、生活課題と争点のつながりが見えないことが大きな壁になっていました。\n\n図表では、候補者情報の不足感、地域課題の理解度、投票意向を並べています。PDF は会議資料として使いやすい分量にまとめました。",
    contentBlocks: [],
    isDemo: true,
  },
  {
...
export const demoDirectorPages: DirectorPageContent[] = [
  {
    ...
    title: "所長から",
    summary:
      "松笠研究所は、結論だけを急いで並べるのではなく、どう調べたか、どこまで言えるかを読み手と共有します。",
    body:
    ...
    roleCards: [
      {
        title: "役割",
        body: "編集方針、公開基準、更新の優先順位を確認します。",
      },
      {
        title: "担当する領域",
        body: "選挙、ケア、雇用、地域社会、情報環境を横断して、公開の軸を確認します。",
      },
      {
        title: "先に示すもの",
    ...
    stanceTitle: "速さより、公開の筋を重視します",
    stanceDescription:
      "読んだ直後の印象だけで終わらず、あとから見返しても判断材料が残る公開にします。",
    stanceCards: [
      {
        title: "名前より判断基準を前に出します",
        body: "個人の肩書きより、どんな基準で公開しているかが分かることを優先します。",
      },
      {
        title: "断定を急がない運営を続けます",
        body: "一度の調査や一つの数字だけで社会全体を言い切らず、更新の余地を残して公開します。",
      },
      {
...
export const demoFinancialStatements: FinancialStatement[] = [
  {
    ...
    body:
      "この決算資料では、年間の収入と支出に加え、調査と公開に直接関わる費用の使途を確認できるようにしています。",
    isDemo: true,
  },
];
...
export const demoPosts: BlogPost[] = [
  {
    ...
    body:
      "地方選挙について若年層へ聞くと、政治そのものへの嫌悪感よりも、候補者と論点が分かりにくいことへの戸惑いが先に語られます。選挙公報を開いても差が読み取りにくく、地域の課題が自分の生活へどうつながるかが分かりにくいという声が目立ちました。\n\n今回の調査では、投票経験の有無よりも『誰に投票すべきか判断する材料が不足している』感覚が参加意欲を左右していました。とくに初回投票層では、学校教育やニュースから選挙の仕組みは学んでいても、候補者比較の仕方までは身についていない傾向があります。\n\n地域メディア、自治体、候補者自身の情報発信が、政策比較よりもお知らせ型に寄りすぎていることも背景にあります。争点を生活課題の言葉で並べ、候補者差を具体的に伝えることが、参加の入口になりそうです。",
    contentBlocks: [],
    isDemo: true,
  },
  {
